  ...
  <div>
    ...
    <div>
      <el-row :gutter="20">
          ...
          <div>
            ...
            <span class="additem">
              <el-row :gutter="20">
                ...
                <el-col :span="4">
                  <span class="itemBtn">
                <el-button v-on:click="SetCAns(4)" type="success" :id="sets4()">设置选项为答案</el-button><br>
              </span>
                </el-col>
              </el-row>
            </span>
        ...
        <el-col :span="6">
          <span>
            <el-button v-on:click="AddCList" type="success" >添加该题目</el-button>
            <br>
            <br>
