        ...
        <el-tab-pane>
          ...
          <div class="display2">
            <div class="top">
              ...
              <button class="btn2 el-icon-document" @click="exportE">导出试卷</button>
            </div>
            <div class="waimian">
...
<script>
    export default {
      ...
      methods:{
        ...
        {
          let that =this
          that.$http.post('/home/export/teacherexaminfo',{
            tid:that.tid
          }).then(function (res) {
      ...
      //  2：手动组卷
        AddExam:function () {
          ...
          {
            that.$alert('规定时间不是数字', '警告', {
              confirmButtonText: '确定',})
          }
          else if(that.addexam.name=="")
          {
            that.$alert('试卷名为空', '警告', {
              confirmButtonText: '确定',})
          }
        ...
        getExamList:function (item) {
          ...
          if(item==1)
          {
            that.$http.post('/exam/teacher/queryexamt',{
              flag:1,
              tid:that.tid
            }).then(function (res) {
              console.log(res.data)
      ...
      created(){
        let that = this
        that.tid=that.$store.getters.getsId
          that.getExamList(3)
      },
      mounted(){
