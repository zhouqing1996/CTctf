<!--<template>-->
    <!--<div>-->
      <!--<el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb-css">-->
        ...
        <!--&lt;!&ndash;<el-breadcrumb-item></el-breadcrumb-item>&ndash;&gt;-->
        <!--&lt;!&ndash;<el-breadcrumb-item><button class="btn2 el-icon-folder-checked" >完成组卷</button></el-breadcrumb-item>&ndash;&gt;-->
      <!--</el-breadcrumb>-->
      <!--<div><hr/></div>-->
      ...
      <!--<div class="display1">-->
        <!--<el-tabs type="border-card">-->
            ...
            <!--<div class="display2">-->
              ...
              <!--<table >-->
                ...
                <!--<tr v-for=" (f,key) in currentPageData2" :key="key">-->
                  ...
                  <!--<td style="width: 10%">-->
                    <!--&lt;!&ndash;<span  class="span2" @click="Click2(f.fqid)" >添加</span>&ndash;&gt;-->
            ...
            <!--<div class="display2">-->
              ...
              <!--<table >-->
                ...
                <!--<tr v-for=" (j,key) in currentPageData3" :key="key">-->
                  ...
                  <!--<td style="width: 10%">-->
                    <!--&lt;!&ndash;<span  class="span2" @click="Click3(j.jqid)">添加</span>&ndash;&gt;-->
            ...
            <!--<div class="display2">-->
              ...
              <!--<table >-->
                ...
                <!--<tr v-for=" (m,key) in currentPageData4" :key="key">-->
                  ...
                  <!--<td style="width: 10%">-->
                    <!--&lt;!&ndash;<span  class="span2" @click="Click4(m.mqid)">添加</span>&ndash;&gt;-->
            ...
            <!--<div class="display2">-->
              ...
              <!--<table >-->
                ...
                <!--<tr v-for=" (p,key) in currentPageData5" :key="key">-->
                  ...
                  <!--<td style="width: 10%">-->
                    <!--&lt;!&ndash;<span  class="span2" @click="Click5(p.pqid)">添加</span>&ndash;&gt;-->
          ...
          <!--</el-tab-pane>-->
          <!--<el-tab-pane>-->
            <!--<span slot="label" @click="SelfView"><i class="el-icon-date" >完成组卷</i></span>-->
            <!--<div class="display2">-->
              <!--<div>-->
                <!--<h3>选择题</h3>-->
                <!--<div>-->
                ...
                <!--<div>-->
                  <!--<span v-for="(j,key3) in ViewList3":key="key3">-->
                    <!--<li class="item">({{key3+1}}){{j.jqitem}}<br>-->
                      <!--<input type="radio"  value="1">正确<br>-->
                      <!--<input type="radio"  value="0">错误<br>-->
